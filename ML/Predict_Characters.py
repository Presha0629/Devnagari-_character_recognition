...
Paths = [os.path.join(settings.BASE_DIR, "ML", "Model_1"),
         os.path.join(settings.BASE_DIR, "ML", "Model_2"),
         os.path.join(settings.BASE_DIR, "ML", "Model_3"),
         os.path.join(settings.BASE_DIR, "ML", "Model_4"),
         os.path.join(settings.BASE_DIR, "ML", "Model_5")]

Models = np.array([load_model(os.path.join(Path, 'best_val_loss.hdf5')) for Path in Paths])
